...
const FindDuplicates = () => {
  ...
  const fetchDuplicates = async () => {
    ...
    setError(null);
    try {
      const response = await RestaurantFinder.get("/admin/duplicates");
  ...
  const fetchRestaurantDetails = async (restaurantId) => {
    try {
      const response = await RestaurantFinder.get(`/restaurant-fetch/${restaurantId}`);
  ...
  const handleRemoveListing = async (restaurantId) => {
    ...
    try {
      await RestaurantFinder.delete(`/admin/remove_listing/${restaurantId}`);
